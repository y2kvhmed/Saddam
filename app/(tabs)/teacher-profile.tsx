    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.actionsCard}>
          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/create-assignment')}>
            <Ionicons name="add-circle" size={24} color="#007AFF" />
            <Text style={styles.actionText}>Create Assignment</Text>
            <Ionicons name="chevron-forward" size={20} color="#666" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/(tabs)/teacher-submissions')}>
            <Ionicons name="folder" size={24} color="#34C759" />
            <Text style={styles.actionText}>Review Submissions</Text>
            <Ionicons name="chevron-forward" size={20} color="#666" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/upload-lesson')}>
            <Ionicons name="videocam" size={24} color="#FF9500" />
            <Text style={styles.actionText}>Upload Lesson</Text>
            <Ionicons name="chevron-forward" size={20} color="#666" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/class-reports')}>
            <Ionicons name="analytics" size={24} color="#5856D6" />
            <Text style={styles.actionText}>Class Reports</Text>
            <Ionicons name="chevron-forward" size={20} color="#666" />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  roleText: { fontSize: 12, fontWeight: '600', color: '#007AFF', letterSpacing: 1 },
