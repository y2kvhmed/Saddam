    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.actionsCard}>
          ...
          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/(tabs)/manage-users')}>
            <Ionicons name="people" size={24} color="#34C759" />
            <Text style={styles.actionText}>Manage Users</Text>
            <Ionicons name="chevron-forward" size={20} color="#666" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.actionItem} onPress={() => router.push('/(tabs)/admin-classes')}>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#001F3F', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
